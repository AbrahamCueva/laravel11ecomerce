                ...
                <div class="tab-pane fade show active" id="tab-item-register" role="tabpanel"
                    ...
                    <div class="register-form">
                        <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate="">
                            ...
                            <div class="pb-3"></div>
                            <div class="form-floating mb-3">
                                <input id="mobile" type="mobile" class="form-control form-control_gray @error('mobile') is-invalid @enderror" name="mobile"
                            ...
                            <div class="form-floating mb-3">
                                <input id="password" type="password" class="form-control form-control_gray @error('password') is-invalid @enderror"
                                    name="password" required="" value="{{ old('password') }}" autocomplete="new-password">
                            ...
                            <div class="d-flex align-items-center mb-3 pb-2">
                                <p class="m-0">Sus datos personales se utilizarán para respaldar su experiencia en este
                                    sitio web, para
                                    administrar el acceso a su cuenta y para otros fines descritos en nuestra política de privacidad.
                                </p>
                            </div>
                            ...
                            <div class="customer-option mt-4 text-center">
                                ...
                                <a href="{{ route('login') }}" class="btn-text js-show-register">Iniciar sesión</a>
                            </div>
                        </form>
                    </div>
                </div>
