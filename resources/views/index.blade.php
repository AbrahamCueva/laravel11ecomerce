    ...
    <main>
                        ...
                        <div class="overflow-hidden position-relative h-100">
                            ...
                            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                                ...
                                <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">
                                    {{ $slide->subtitle }}</h2>
                                <a href="{{ $slide->link }}"
                                    class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Ver...</a>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="container mw-1620 bg-white border-radius-10">
            ...
            <section class="category-carousel container">
                <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">Te puede gustar</h2>
            ...
            <section class="hot-deals container">
                ...
                <div class="row">
                    <div
                        ...
                        <a href="{{ route('shop.index') }}" class="btn-link default-underline text-uppercase fw-medium mt-3">Ver más</a>
                    </div>
                                            ...
                                            <div class="pc__img-wrapper">
                                                <a href="{{ route('shop.product.details', ['product_slug' => $sproduct->slug]) }}">
                                                    <img loading="lazy"
                                                        ...
                                                        width="258" height="313" alt="{{ $sproduct->name }}t"
                                                        class="pc__img">
                                                </a>
                                            </div>
                                                ...
                                                <div class="product-card__price d-flex">
                                                    <span class="money price text-secondary">
                                                        @if ($sproduct->sale_price)
                                                            <s style="color: red">$
                                                                {{ number_format($sproduct->regular_price, 2) }}</s> $
                                                            {{ number_format($sproduct->sale_price, 2) }}
                                                        @else
                                                            <span class="money price">$
                                                                {{ number_format($sproduct->regular_price, 2) }}</span>
                                                        @endif
                                                    </span>
                                                </div>
                                            </div>
