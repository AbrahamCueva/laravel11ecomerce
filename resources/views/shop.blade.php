                ...
                <div class="accordion" id="price-filters">
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1" data-slider-max="500" data-slider-step="1" data-slider-value="[{{ $min_price }},{{ $max_price }}]" data-currency="$" />
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            ...
                            <option value="3" {{ $order == 3 ? 'selected' : '' }}>Precio, barato a caro</option>
                            <option value="4" {{ $order == 4 ? 'selected' : '' }}>Precio, caro a barato</option>
                        </select>
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    @if(Cart::instance("wishlist")->content()->where('id', $product->id)->count() > 0)
                                        <form method="POST" action="{{ route('wishlist.item.remove', ['rowId' => Cart::instance("wishlist")->content()->where('id', $product->id)->first()->rowId]) }}">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist filled-heard"
                                                title="Quitar de los favoritos">
