                    ...
                    <form name="addtocart-form" method="post">
                        <div class="product-single__addtocart">
                            ...
                            <button type="submit" class="btn btn-primary btn-addtocart js-open-aside"
                                data-aside="cartDrawer">Agregar al cesto</button>
                        </div>
                    </form>
                                    ...
                                    <div class="product-card__price d-flex">
                                        <span class="money price">
                                            @if ($rproduct->sale_price)
                                                <s style="color: red">$ {{ number_format($rproduct->regular_price, 2) }}</s>       $ {{ number_format($rproduct->sale_price, 2) }}
                                            @else
                                                <span class="money price">$ {{ number_format($rproduct->regular_price, 2) }}</span>
                                            @endif
                                        </span>
                                    </div>
