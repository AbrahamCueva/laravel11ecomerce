...
class AdminController extends Controller
{
    ...
    public function brand_store(Request $request)
    {
        ...
        $brand->save();
        return redirect()->route('admin.brands')->with('status', '¡Marca creada exitosamente!');
    }
    ...
    public function category_store(Request $request)
    {
        ...
        $category->save();
        return redirect()->route('admin.categories')->with('status', '¡Categoría creada exitosamente!');
    }
    ...
    public function product_store(Request $request)
    {
        $request->validate([
            ...
            'featured' => 'required',
            'quantity' => 'required',
            'image' => 'required|mimes:png,jpg,jpeg:max2048',
        ...
        $product->save();
        return redirect()->route('admin.products')->with('status', '¡Producto creado exitosamente!');
    }
    ...
    public function update_product(Request $request)
    {
        $request->validate([
            ...
            'featured' => 'required',
            'quantity' => 'required',
            'image' => 'mimes:png,jpg,jpeg:max2048',
            'category_id' => 'required',
            'brand_id' => 'required',
        ]);
    ...
    public function update_order_status(Request $request)
    {
        ...
        return back()->with("status", "Estado cambiado exitosamente");
    }
    ...
    public function slide_store(Request $request)
    {
        ...
        $slide->save();
        return redirect()->route('admin.slides')->with('status', '¡Slide creado exitosamente!');
    }
    ...
    public function slide_update(Request $request)
    {
        ...
        $slide->save();
        return redirect()->route('admin.slides')->with('status', '¡Slide actualizado exitosamente!');
    }
    ...
    public function slide_delete($id)
    {
        ...
        $slide->delete();
        return redirect()->route('admin.slides')->with('status', '¡Slide eliminado exitosamente!');
    }
